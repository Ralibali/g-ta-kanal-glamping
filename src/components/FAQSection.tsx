...
const FAQSection = () => {
  ...
  const faqs = lang === "en" ? [
    ...
    { q: "Can children stay in the glamping tents?", a: "Of course! Children up to 12 years have discounted prices and can sleep together with adults in the double bed or on the sofa bed. All tents accommodate up to four guests. Perfect accommodation for families by Göta Canal." },
    ...
    { q: "Are you the same business as Bergs Slussar Vandrarhem (hostel)?", a: "No. Bergs Slussar Glamping (Go Glamping Sweden) is an independent glamping site operated by Aurora Media AB. We are not owned by, part of, or affiliated with Bergs Slussar Vandrarhem or any other lodging at Bergs Slussar – we just happen to share the same beautiful location by Göta Canal." },
  ] : [
    { q: "Vad kostar glamping vid Bergs Slussar och vad ingår i priset?", a: "Priserna varierar med säsong och tält och visas direkt i bokningswidgeten ovan – välj datum och antal gäster så ser du totalpriset. I priset ingår alltid städning, bäddade sängar med sänglinne, handdukar, el, värme, fläkt, minikylskåp, gasolvärmare samt kaffe, te och en flaska vatten. Frukost via Bostället kan läggas till som tillval. Sen utcheckning till kl. 12:00 kan bokas för 399 kr i mån av plats." },
    ...
    { q: "Vilka bokningsvillkor gäller?", a: <>Incheckning från kl. 15:00, utcheckning senast kl. 10:00. Kostnadsfri avbokning upp till fem dagar före ankomst. Sen utcheckning till kl. 12:00 kan erbjudas mot 399 kr. Vill du vara helt trygg kan du lägga till avbokningsskydd för 399 kr vid bokning – då får du full återbetalning oavsett anledning, ända fram till ankomstdagen. <a href="/bokningsvillkor" className="text-accent font-medium underline underline-offset-4 hover:no-underline">Läs alla bokningsvillkor →</a></> },
              ...
              <div className="bg-card rounded-2xl border border-border/50 overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openIdx === i ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                  <div className="px-6 pb-6">
                    <div className="text-muted-foreground leading-relaxed">{faq.a}</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
