...
const tents = [
  {
    ...
    image: tentImg1,
    description:
      "En oas av komfort. Rymlig dubbelsäng med mjuka kuddar och sänglinne av högsta kvalitet. Erbjuder även en extrabädd.",
  ...
  },
  {
    ...
    image: tentImg2,
    description:
      "Rymlig dubbelsäng, högkvalitativt sänglinne och en bäddsoffa. Perfekt för familjer som söker äventyr.",
  ...
  },
  {
    ...
    image: tentImg3,
    description:
      "Vårt mysigaste tält där lugn och harmoni möts. Perfekt för dig som söker avkoppling. Husdjur välkomna.",
              ...
              <div className="group bg-card rounded-3xl overflow-hidden border border-border/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="p-7">
                  ...
                  <div className="flex gap-2 mb-4 flex-wrap">
                    {tent.extras.map((e) => (
                      <span key={e} className="text-xs bg-secondary text-secondary-foreground px-3 py-1 rounded-full font-medium">
                        {e}
                      </span>
                    ))}
                  </div>
                  ...
                  <a
                    href="#boka"
                    className="inline-block bg-primary text-primary-foreground px-6 py-3 rounded-full text-sm font-semibold hover:scale-105 transition-transform w-full text-center"
                  >
                    Se pris & boka →
                  </a>
                </div>
