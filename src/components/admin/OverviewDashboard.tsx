    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          ...
          { icon: Users, label: 'Unika besökare', value: metrics.uniqueSessions, color: 'text-accent', bg: 'bg-accent/10', delta: { current: metrics.uniqueSessions, previous: metrics.prevUnique } },
          { icon: BarChart3, label: 'Sidor/besök', value: metrics.avgPages, color: 'text-orange-500', bg: 'bg-orange-500/10' },
          { icon: Zap, label: 'CTA-klick', value: metrics.ctaClicks, color: 'text-green-500', bg: 'bg-green-500/10' },
          { icon: MousePointerClick, label: 'CTA-rate', value: `${metrics.ctaRate}%`, color: 'text-purple-500', bg: 'bg-purple-500/10' },
          { icon: TrendingUp, label: 'Avvisningsfrekvens', value: `${metrics.bounceRate}%`, color: 'text-red-500', bg: 'bg-red-500/10' },
              ...
              {clickAnalysis.topCtas.length === 0 ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-[10px] text-muted-foreground mt-1">
                    Knappar som "Boka", "Kontakta" och "Läs mer" spåras automatiskt.
                  </p>
                </div>
              ) : (
