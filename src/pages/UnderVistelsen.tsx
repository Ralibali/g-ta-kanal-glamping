...
export default function UnderVistelsen() {
  ...
  const t = isSv ? {
    ...
    serviceCardBody: "Servicekortet i tältet är nyckeln till servicehuset (toalett, dusch och skötrum), som ligger ca 150 m bort. Ta det gärna med i fickan när ni går dit — annars behövs det inte till något.",
    parking: "Parkering",
    parkingBody: "Ni parkerar enklast på den allmänna parkeringen vid Berg (liten avgift). Vill ni parkera gratis finns en pendlarparkering precis vid infarten till Berg — några minuters promenad bort.",
    breakfastInfo: "Frukost & leverans",
    breakfastInfoBody: "Har ni beställt frukost bakas och levereras den av Bostället Vedungsbageri och serveras runt kl 08:30. Vi skickar ett SMS så fort den står klar vid portalen — så kan ni ta den i lugn och ro när det passar.",
    mower: "Gräsklippning dagtid",
    mowerBody: "Vi klipper gräset dagtid mellan kl 10 och 15 så att det är fint och välskött åt er. Skulle ljudet störa er precis då — säg bara till, så pausar vi direkt.",
    ...
    serviceCardBody: "The service card in your tent is the key to the service house (toilet, shower and changing room), about 150 m away. Pop it in your pocket when you walk over — you won't need it for anything else.",
    parking: "Parking",
    parkingBody: "The easiest option is the public parking at Berg (small fee). If you'd rather park for free, there's a commuter lot right at the entrance to Berg — a few minutes' walk away.",
    breakfastInfo: "Breakfast & delivery",
    breakfastInfoBody: "If you've ordered breakfast, it's baked and delivered by Bostället Vedungsbageri and served around 8:30. We'll text you as soon as it's ready at the portal — so you can grab it whenever suits you.",
