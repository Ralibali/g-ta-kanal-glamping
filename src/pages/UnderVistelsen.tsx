...
export default function UnderVistelsen() {
  ...
  const t = isSv ? {
    ...
    breakfastInfoBody: "Har ni beställt frukost kommer den varm och nybakad från Bostället Vedungsbageri och står vid portalen runt kl 08:30. Vi skickar ett litet SMS så fort den är på plats — så kan ni hämta den i lugn och ro när det passar.",
