...
export default function UnderVistelsen() {
  ...
  const t = isSv ? {
    ...
    breakfastInfoBody: "If you've ordered breakfast, it arrives warm and freshly baked from Bostället Vedungsbageri and waits for you at the portal around 8:30. We'll send you a little text as soon as it's there — so you can pick it up whenever suits you.",
